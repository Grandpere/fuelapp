...
1. Make reminder rules easier to read as a lifecycle instead of a flat list of states.
2. Surface the gap between configured rules, active tracking, soon-due rules, and already-due rules.
