...
## Goal
Add a local public fuel station directory from the official flux instantané v2 des prix des carburants from data.gouv, then expose it safely for users and support workflows.
...
## Scope notes
- Use the official flux instantané v2 des prix des carburants from data.gouv as the ingestion source.
