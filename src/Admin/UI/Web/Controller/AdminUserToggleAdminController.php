...
final class AdminUserToggleAdminController extends AbstractController
{
    ...
    #[Route('/ui/admin/users/{id}/toggle-admin', name: 'ui_admin_user_toggle_admin', methods: ['POST'], requirements: ['id' => self::UUID_ROUTE_REQUIREMENT])]
    public function __invoke(Request $request, string $id): RedirectResponse
    {
        ...
        if (!is_scalar($token) || !$this->isCsrfTokenValid('admin_user_toggle_admin_'.$id, (string) $token)) {
            throw new NotFoundHttpException();
        }
